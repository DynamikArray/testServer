...
pkg_build_deps=(core/make core/gcc bsr_test/testClient)
...
do_install() {
  do_default_install
  echo "Begining do_install commands"
  local app_path="$pkg_prefix/app"

  echo "This is app path"
  echo $app_path
  ...
  #  index.js \
  #  $app_path
  #echo "Ended do_install commands"
}
